...
import { Button, Form, FormGroup, Label, Row, Input, Col, FormFeedback, Breadcrumb, BreadcrumbItem } from 'reactstrap';
...
function RenderFeedback({  feedback, postFeedback }) {
    if (feedback != null)
        return (
            <div className="col-12 col-md-5 m-1">   
                <FormFeedback  postFeedback={postFeedback} />
            </div>
        );
    else
        return (
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={{ size: 3, offset: 1 }}>
                                    <Control.select model=".contactType" name="contactType"
                                        className="form-control" value={this.state.contactType} >
                                        <option>Tel.</option>
                                        <option>Email</option>
                                    </Control.select>
                                </Col>
